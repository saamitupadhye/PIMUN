  ...
  },
{
    ...
    content: '"The committee Session 1 starts with Delegation of United Kingdom’s Speaker’s list followed by United States of America. United Kingdom openly supports Ukraine while addressing countless amounts of deaths, which are estimated to be around 14200 – 14400 military and civilian deaths during the War in Donbas; up to 1,000,000 estimated casualties during the Russian invasion of Ukraine. Russia comments that Ukraine has also caused civilian casualties to the same extent as Russia. Ukraine comments that United Kingdom is right about Russia condemning the act. Point of Information raised by Russia was about them not condemning any act. Ukraine changing its words to Russia is causing the act. Delegate of United States of America states that they have provided $66.5 billion in military assistance since Russia launched its full-scale invasion of Ukraine on February 24, 2022, andapproximately $69.2 billion in military assistance since Russia’s initial invasion of Ukraine in 2014. The United States of America has now used the emergency Presidential Drawdown Authority on 55 occasions since August 2021 to provide Ukraine military assistance totaling approximately $31.7 billion from DoD stockpiles.',
    imageUrl: ARTICLE_IMAGES.assemblyVote,
  ...
  },
{
    ...
    content: `The Delegate of United Kingdom said in United Nations Office for Disarmament Affairs(UNODA) that having a Nuclear Power is a responsibility and not a luxury. The United Kingdom believes that the entire world should dispose off of their Nuclear Weapons except for the five countries which were allowed by the Non-Proliferation Treaty. The United Kingdom supports the Disarmament Motion but also believes that it should have Nuclear Weapons in its possession as a “responsibility”`,
    imageUrl: ARTICLE_IMAGES.assemblyVote,
    tags: ['PIMUN', 'PIMUN 2025', 'UNODA', 'Nuclear weapons', 'Responsibility' , 'Weapons Disarmament','Weapons'],
    status: 'published',
  },
{
    id: '7',
    ...
    date: '2025-04-12',
    author: 'Anay Kathuria',
    summary: 'Russia has moved tactical nuclear weapons from its own borders into neighboring Belarus, several hundred miles closer to NATO territory.',
    content: 'Member of the Deustche Presse-Agentur(German Press Agency) asked the Delegate of Russia about their intention behind sending Nuclear Weapons to Belarus to which the Delegate replied, that the Country of Belarus asked for the weapons themselves and these weapons were for security purposes only and not for aggression. When the question was asked to the Delegate regarding the threat of Russia using a Nuclear Weapon in the war; the Delegate replied “Use of Nuclear Weapons was an option for Russia but they chose not toescalate the conflict to such a level and did not attack with Nuclear Bombs. If they really were to adhere with their threat, they would have used Nuclear Weapons earlier and the situation would not be like it is today. When asked about Russia’s views on Disarmament of Nuclear Weapons the delegate said that Russia prefers a gradual and slow disarmament so that there can be trust between all the countries.' ,
    imageUrl: ARTICLE_IMAGES.assemblyVote,
    tags: ['PIMUN', 'PIMUN 2025', 'UNODA', 'Debate', 'RUSSIA', 'Nuclear Weapons', 'BELARUS'],
    status: 'published',
  },
{
    id: '8',
    title: 'Ukraine’s views and belief on Russia’s claim of no animosity',
    channel: 'AL Jazeera',
    event: 'UNSC',
    date: '2025-04-12',
    author: 'Anay Kathuria',
    summary: 'In the Press Conference, Delegate of Russia said “There is no animosity between Russia and Ukraine”. This statement was opposed by that of the Ukrainian Delegate.',
    content: 'When the Ukrainian delegate was asked for his view on the Delegate of Russia’s statement the delegate replied “If a thief entered your house and stole items of your house and claimed your entire house as their property, would you go to the police? The same is happening in the real world Russia-Ukraine conflict. Russia invaded Ukraine and claimed Ukrainian land for themselves and Ukraine went to the United Nations for help.” This statement of the Delegate implies that they do not agree on Russia’s claim of no animosity.         The delegate also made Ukraine’s stand very clear on the present conflict. They do not wish to increase the conflict but if Russia is not going to stop, they are not going to stop either.',
    imageUrl: ARTICLE_IMAGES.assemblyVote,
    tags: ['PIMUN', 'PIMUN 2025', 'UNSC', 'Debate', 'RUSSIA', 'UKAINE', 'Animosity', 'Russia-Ukraine Conflict', 'SIDS'],
    status: 'published',
  },
  {
    id: '9',
